...
$(document).ready(function () {
	...
	$("#output-update").on("click", function () {
		imageproc.apply();
	});
	...
	$("#gaussian-customize-sigma").hide();
	$("#gaussian-customize-kernel").hide();
	$("#blur-customization").change(() => {
		if ($("#blur-customization").val() == "default") {
			$("#gaussian-default-panel").show();
			$("#gaussian-customize-sigma").hide();
			$("#gaussian-customize-kernel").hide();
		} else if ($("#blur-customization").val() == "customized") {
			$("#gaussian-customize-sigma").show();
			$("#gaussian-customize-kernel").show();
			$("#gaussian-default-panel").hide();
		}
	});
});
